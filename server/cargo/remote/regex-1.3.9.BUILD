...
rust_library(
    ...
    crate_type = "lib",
    deps = [
        "@server__aho_corasick__0_7_13//:aho_corasick",
        "@server__memchr__2_3_3//:memchr",
        "@server__regex_syntax__0_6_18//:regex_syntax",
        "@server__thread_local__1_0_1//:thread_local",
    ],
    srcs = glob(["**/*.rs"]),
